...
/* Tag/index.html.twig */
class __TwigTemplate_9ffa4d216409d7f7b5334680b93572d44b4bf9cea717c8f087fe77532d2e38a1 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "   <h2 class=\"tagTitle text-center\"> Liste des tags: </h2>
    <ul>
        ";
        // line 8
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["tags"]) || array_key_exists("tags", $context) ? $context["tags"] : (function () { throw new RuntimeError('Variable "tags" does not exist.', 8, $this->source); })()));
...
{% block body %}
   <h2 class=\"tagTitle text-center\"> Liste des tags: </h2>
    <ul>
        {% for tag in tags %}
            <li>{{ tag.name }} </li>
        {% endfor %}
...
{% endblock %}", "Tag/index.html.twig", "/home/wilder/workspace/symfony/quete1/blog/templates/Tag/index.html.twig");
    }
}

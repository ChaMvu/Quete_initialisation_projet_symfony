...
class __TwigTemplate_3cb4db48855bfc2de4373beda5c97e4fda810184ec706a12f2c0074cc4e667ba extends \Twig\Template
{
    private $source;
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <div class=\"align-content-around\">
        ...
        ";
        // line 9
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 9, $this->source); })()), "searchField", [], "any", false, false, false, 9), 'row');
        echo "
    ...
    <h1 class=\"text-center articleTitle\">All articles from article s table : </h1>
    ...
    <div class=\"container\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["article"]) {
            ...
            echo "</h2>
                <p>";
            // line 24
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["article"], "content", [], "any", false, false, false, 24), "html", null, true);
            echo "</p>
            </div>
...
";
    ...
    {
        return array (  166 => 31,  163 => 30,  156 => 28,  139 => 24,  131 => 23,  127 => 21,  109 => 20,  97 => 11,  92 => 9,  88 => 8,  84 => 6,  75 => 5,  57 => 3,  35 => 1,);
    }
...
{% block body %}
    ...
    <div class=\"container\">
        {% for article in articles %}
            ...
            <div>
                <h2 class=\"articles\">{{ loop.index }} / {{ article.title }} - Category : {{ article.category.name }}</h2>
                <p>{{ article.content }}</p>
            </div>
